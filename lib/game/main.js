...
MyGame = ig.Game.extend({
    ...
    // Generate the layer status entity
    ig.game.spawnEntity( EntityLevelStatus, 30, 30, {flip:this.flip} );
    ig.game.spawnEntity( EntityLevelStatusMask, 30, 30, {flip:this.flip} );
	},
